...
export const DashboardDestinationUploadSection: React.FC = () => {
  return (
    <section className="mt-8 rounded-2xl bg-[#1A1A1A]/5 border border-[#1A1A1A]/10 p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-semibold text-black">Destination Upload</h2>
          <p className="text-sm text-black/60">Add new destinations with visuals.</p>
        </div>
      </div>
      <form className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm text-black/70">Location / Municipality</label>
          <input
            type="text"
